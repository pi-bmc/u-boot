...
enum sysinfo_id {
	...
	SYSID_SM_MEMARRAY_USE,
	SYSID_SM_MEMARRAY_ECC,
	SYSID_SM_MEMARRAY_NUM_DEV,
	SYSID_SM_MEMARRAY_MAXCAP,

	/* Memory Device (Type 17) */
	SYSID_SM_MEMDEV_TOTALWIDTH,
	SYSID_SM_MEMDEV_DATAWIDTH,
	SYSID_SM_MEMDEV_SIZE,
	SYSID_SM_MEMDEV_EXTSIZE,
	SYSID_SM_MEMDEV_FORMFACTOR,
	SYSID_SM_MEMDEV_LOCATOR,
	SYSID_SM_MEMDEV_TYPE,
	SYSID_SM_MEMDEV_TYPEDETAIL,
	SYSID_SM_MEMDEV_SPEED,

	/* Memory Array Mapped Address (Type 19) */
	SYSID_SM_MEMMAP_START,
	SYSID_SM_MEMMAP_END,
	SYSID_SM_MEMMAP_PARTWIDTH,
	SYSID_SM_MEMMAP_EXTSTART,
	SYSID_SM_MEMMAP_EXTEND,
